...
public class WorkerAddRestrictedFood extends AsyncTask<String, Void, String> {
	...
	public WorkerAddRestrictedFood(Context c_, String array_rfood) {
		context = c_;
		foodIds = array_rfood;
	}
	...
	public String addRfood()
	{
		if (helpers.haveNetworkConnection(context))
		{
			...
			parameters.add(new BasicNameValuePair("restrictedFood", rfoodIds));
