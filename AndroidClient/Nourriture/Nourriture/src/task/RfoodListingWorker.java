...
public class RfoodListingWorker  extends AsyncTask<String, Void, String> {
	...
	private RestrictedFoodFragment rfoodfragment;
	private View rootview;

	public RfoodListingWorker(Context c_, View rootView_,ImageLoader imageLoader_, RestrictedFoodFragment rfoodfragment_) {
		context = c_;
