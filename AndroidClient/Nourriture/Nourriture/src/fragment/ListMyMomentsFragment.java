...
public class ListMyMomentsFragment extends Fragment implements OnClickListener {
	private Context context;
	private View rootView;
	private ImageLoader imageLoader;
	private DisplayImageOptions options;
	public ListMyMomentsFragment(){
	}
	@Override
			...
			Bundle savedInstanceState_) 
	{
		...
		new getAllUserMoment(context, rootView, Globals.MainActivityDatas.user,imageLoader, options).execute();
		return rootView;
	}
	...
	public void onStart() {
		...
		Tracker t = ((MyApplication) getActivity().getApplication()).getTracker(
			...
			t.setScreenName("List moments of current user Fragment");
