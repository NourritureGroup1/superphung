...
import adapter.RecipePagerAdapter;
...
public class SliderElementsRecipe extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		.build();
		pager.setAdapter(new RecipePagerAdapter(Globals.listRecipe, getApplicationContext(), imageLoader, options, type));
